...
const LeafNode = memo(({ node, style, padding }: LeafNodeProps) => {
    return (
        ...
        >
            <div className="flex flex-col justify-center p-0 border border-gray-700 rounded-2xl h-full w-full overflow-hidden ">
                ...
                <div className="flex p-2 text-xs text-gray-400 overflow-auto h-full w-full items-center justify-center">
